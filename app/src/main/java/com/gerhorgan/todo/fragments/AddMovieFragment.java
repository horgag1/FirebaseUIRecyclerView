package com.gerhorgan.todo.fragments;
...
import com.gerhorgan.todo.R;
import com.gerhorgan.todo.model.Movie;
import com.google.firebase.database.DatabaseReference;
import com.google.firebase.database.FirebaseDatabase;

/**
 * Created by gerhorgan on 30/08/2017.
 */
...
public class AddMovieFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch(view.getId()){
            case R.id.b_submit:
                if(!isEmpty(movieName) && !isEmpty(movieLogo)){
